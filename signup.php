            ...
            <div style="padding-top:50px;">
                ...
                <form action="./includes/signup.inc.php" method="post">
                    <div class="text-center">
                        ...
                        <div>
                            <input class="input-field" type="email" name="mail" placeholder="Email"/>
                        </div>
                        <div>
                            <input class="input-field" type="text" name="mobnum" placeholder="Enter your mobile number...">
                        </div>
                        <div>
                        ...
                        <div>
                            <input class="input-field" rows="10" cols="30" type="textarea" name="address" placeholder="Enter your address..." >
                        </div>
                        <div>
                            <input class="input-field" type="text" placeholder="Enter your state..." name='state'>
                        </div>
                        <div class="p-1">
