                ...
                <div style="padding-top:160px;">
                    ...
                    <div class="container text-center">
                        <?php
                            if(isset($_GET["mail"])){
                                if($_GET["mail"]=='sent'){
                                    echo"<p class='pt-1' style='font-size:12px; color:green'>Verification link has been sent to ur mail</p>";
                                }
                            }
                            if(isset($_GET["user"])){
                                if($_GET["user"]=='nouser'){
